...
|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `dev`   | [![CodeQL](https://github.com/dnsmin/dnsmin-ui/actions/workflows/codeql-analysis.yml/badge.svg?branch=dev)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/codeql-analysis.yml)           | [![MegaLinter](https://github.com/dnsmin/dnsmin-ui/actions/workflows/mega-linter.yml/badge.svg?branch=dev)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/mega-linter.yml)           | [![Python Build](https://github.com/dnsmin/dnsmin-ui/actions/workflows/python-build.yml/badge.svg?branch=dev)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/python-build.yml)           | [![Image Build](https://github.com/dnsmin/dnsmin-ui/actions/workflows/image-build.yml/badge.svg?branch=dev)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/image-build.yml)           |
| `0.1.0` | [![CodeQL](https://github.com/dnsmin/dnsmin-ui/actions/workflows/codeql-analysis.yml/badge.svg?branch=release/0.1.0)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/codeql-analysis.yml) | [![MegaLinter](https://github.com/dnsmin/dnsmin-ui/actions/workflows/mega-linter.yml/badge.svg?branch=release/0.1.0)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/mega-linter.yml) | [![Python Build](https://github.com/dnsmin/dnsmin-ui/actions/workflows/python-build.yml/badge.svg?branch=release/0.1.0)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/python-build.yml) | [![Image Build](https://github.com/dnsmin/dnsmin-ui/actions/workflows/image-build.yml/badge.svg?branch=release/0.1.0)](https://github.com/dnsmin/dnsmin-ui/actions/workflows/image-build.yml) |
...
```
git clone https://github.com/dnsmin/dnsmin-ui.git
cd dnsmin-ui
docker compose up -d
```
...
Please see our
[Security Policy](https://github.com/dnsmin/dnsmin-ui/blob/main/.github/SECURITY.md).
...
Please see our
[Code of Conduct](https://github.com/dnsmin/dnsmin-ui/blob/main/.github/CODE_OF_CONDUCT.md).
...
For additional
information, [see the full license](https://github.com/dnsmin/dnsmin-ui/blob/main/LICENSE).
